...
#For example, if the first line of input is 53.1 and the second line of input is 0.8, then the first line of output is 0.0 
#and the second line of output is 53.1*cos(0.8*cos(1*√9.8/53.1)) - 53.1*cos(0.8) ~ 2.6689.
